...
export function Calendar({
  ...
  const adjustedEndHour =
    validEndHour <= validStartHour ? validStartHour + 8 : validEndHour;
            ...
            {days.map((_, dayIndex) => {
              ...
              return (
                <div
                  ...
                  data-block-size={blockSizeMinutes}
                  onMouseDown={
                    disabled ? undefined : () => handleMouseDown(dayIndex, time)
                  }
                  onMouseEnter={
                    disabled
                      ? undefined
                      : () => handleMouseEnter(dayIndex, time)
                  }
                />
              );
            })}
