  ...
  return (
    <div className={styles.container}>
      <div className={styles.modesRow}>
        ...
        <button
          className={`${styles.modeButton} ${styles.cannot} ${
            currentMode === "cannot" ? styles.active : ""
          }`}
        ...
        <button
          className={`${styles.modeButton} ${styles.preferNot} ${
            currentMode === "prefer-not" ? styles.active : ""
          }`}
        ...
        <button
          className={`${styles.modeButton} ${styles.available} ${
            currentMode === "available" ? styles.active : ""
          }`}
        ...
        <button
          className={`${styles.modeButton} ${styles.preferred} ${
            currentMode === "preferred" ? styles.active : ""
          }`}
